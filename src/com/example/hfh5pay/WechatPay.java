...
public class WechatPay extends Pay {
	...
	public WechatPay(IPayListener listener) {
		super(listener);
	}
	...
	protected void payDoing(final Activity activity) {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				String result = HttpUtils.sendPostUTF8(getHost() + "/pay/unifiedorder", params);
				...
				try {
					...
					if("success".equalsIgnoreCase(code)) {
						...
						it.putExtra(DYH5Activity.PAGE_SEE, DYH5Activity.PAGE_WEIXIN);
